...
public class JuegoDados2 {
	...
	public JuegoDados2(Jugador ju1, Jugador ju2, int caras,int rondas) {
		this(ju1,ju2,caras,rondas,2);
	}

	public JuegoDados2(Jugador ju1, Jugador ju2, int caras,int rondas, int numeroDados) {
		this.j1=ju1;
		j2=ju2;
        vaso = new Cubilete(numeroDados,caras);
		this.rondas = rondas;
		minimo=7;
	}
	...
	public Jugador jugar() {
		...
		for(int i =0; i<rondas; i++) {
			int dados1 = j1.tirarDados(vaso);
			
			int dados2 = j2.tirarDados(vaso);
	...
	public static void main(String[] args) {
		...
		JuegoDados2 juego1 = new JuegoDados2(j1,j10,6,10,2);
